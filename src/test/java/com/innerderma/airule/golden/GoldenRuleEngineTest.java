    ...
    private static List<AiRule> seedRules() {
        return List.of(
                ...
                rule("R002", AiRuleCategory.INPUT_IMAGE, 900,
                        "{\"image_quality_failed\":true,\"face_not_detected\":true,\"or_image_blurry\":true}",
                        "{\"request_retake\":true,\"confidence_policy\":\"REDUCE\"}", "[\"NO_DEFINITIVE_STATE\"]"),
                ...
                rule("R025", AiRuleCategory.SKIN_STATE, 650,
                        "{\"low_confidence\":true}",
                ...
                // R001~R019
                rule("R001", AiRuleCategory.SAFETY, 950,
                ...
                rule("R003", AiRuleCategory.PROCEDURE, 850,
                ...
                rule("R004", AiRuleCategory.PROCEDURE, 850,
                ...
                rule("R005", AiRuleCategory.PROCEDURE, 850,
                ...
                rule("R008", AiRuleCategory.SKIN_STATE, 750,
